...
Note: Using the [API](https://robot-configuration-api-6wob2oz53q-uc.a.run.app/docs#/Query/download_file_download_file_get), you can download the segmapping .png file. Save it under the path above and create `segmapping_png.yaml` with values like:
```yaml
